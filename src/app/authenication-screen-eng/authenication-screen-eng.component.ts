...
@Component({
  selector: 'app-authenication-screen-eng',
  templateUrl: './authenication-screen-eng.component.html',
  styleUrls: ['./authenication-screen-eng.component.scss']
})
export class AuthenicationScreenEngComponent {
  form!: FormGroup;
  loading = false;
  submitted = false;
  ...
  clickMethod() {
      ...
      const confirmDialog = this.dialog.open(ConfirmDialogComponent, {
        ...
        panelClass: 'custom-dialog-container-au', 
          ...
          data: {
            title: ' If authentication code email notification is not received',
            message: `If email not found in Inbox, please check your spam folder.
